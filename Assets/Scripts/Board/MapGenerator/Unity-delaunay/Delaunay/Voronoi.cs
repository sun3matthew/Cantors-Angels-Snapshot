...
//			_plotBounds = null;
		...
		public Voronoi (List<Vector2> points, List<uint> colors, Rect plotBounds, CoreRandom coreRandom)
		{
		...
		private void AddSite (Vector2 p, uint color, int index)
		{
			...
			float weight = _coreRandom.Next(100f);
		...
		public List<Vector2> HullPointsInOrder ()
		{
			...
			EdgeReorderer reorderer = new(hullEdges, VertexOrSite.SITE);
